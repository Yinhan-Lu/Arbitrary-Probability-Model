...
# ==========================================================================
# CONVERGENCE EXPERIMENT: Baseline Model (Standard Autoregressive GPT-2)
# ==========================================================================
# Standard left-to-right autoregressive language modeling.
# No conditioning - serves as reference baseline for comparison.
# Uses FP16 mixed precision training.

echo "========================================="
echo "CONVERGENCE EXPERIMENT: Baseline Model"
echo "  Model: Standard Autoregressive GPT-2"
echo "  FP16: Enabled"
...
# Training parameters (matching other converge experiments for fair comparison)
EXP_NAME="converge_baseline"
