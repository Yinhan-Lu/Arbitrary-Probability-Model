...
# ==========================================================================
# BUG FIX ABLATION: NEW BEHAVIOR (use attention_mask for valid positions)
# ==========================================================================
# This experiment uses the NEW correct behavior where valid_positions is
# determined by attention_mask, which correctly includes EOS tokens.
# This should result in Mode 2 being the WORST (due to train/eval consistency).

echo "========================================="
echo "BUG FIX ABLATION: NEW BEHAVIOR"
echo "  valid_positions: using attention_mask (includes EOS)"
echo "  Expected: Mode 2 = WORST"
echo "========================================="
