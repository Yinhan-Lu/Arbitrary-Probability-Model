...
echo "     python train.py --model_type conditional --model_config small --num_epochs 1 --batch_size 8 --do_eval"
echo ""
echo "  2. For training DistilGPT-2 baseline:"
echo "     python train.py --model_type baseline --model_config distilgpt2 --num_epochs 3 --batch_size 16 --do_eval"
echo ""
