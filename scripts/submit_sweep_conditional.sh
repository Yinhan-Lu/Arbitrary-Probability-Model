#!/bin/bash
# ==========================================================================
# CONDITIONING PERCENTAGE SWEEP: CONDITIONAL MODEL
# ==========================================================================
# Systematic study of conditioning percentage effects on conditional model.
#
# Configurations:
...
#
# Usage:
#   ./scripts/submit_sweep_conditional.sh           # Submit all experiments
#   ./scripts/submit_sweep_conditional.sh --dry-run # Show what would be submitted
#   ./scripts/submit_sweep_conditional.sh --skip-baseline # Skip 0-40% (already done)
# ==========================================================================
...
echo "========================================="
echo "CONDITIONING PERCENTAGE SWEEP: CONDITIONAL"
echo "========================================="
echo "Configurations: ${#CONFIGS[@]} conditioning ranges"
echo "Model: Conditional (attention mask based)"
...
for config in "${CONFIGS[@]}"; do
    ...
    EXP_NAME="sweep_${LABEL}_cond"

    # Construct job name (max 15 chars for SLURM)
    JOB_NAME="${LABEL:0:10}_cond"

    echo "----------------------------------------"
    echo "Experiment: $EXP_NAME"
    echo "  Model: conditional"
...
echo "  python utils/plot_comparison_metrics.py experiments/sweep_*_cond_*"
