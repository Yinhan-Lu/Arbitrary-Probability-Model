#!/bin/bash
#SBATCH --job-name=conv_sgpt_temp
...
# ==========================================================================
# CONVERGENCE EXPERIMENT: Sigma GPT (Temporal Ordering) with Early Stopping
# ==========================================================================
...
echo "========================================="
echo "CONVERGENCE EXPERIMENT: Sigma GPT (Temporal)"
...
EXP_NAME="converge_sigmagpt_temporal"
