#!/bin/bash
# ==========================================================================
# CONDITIONING PERCENTAGE SWEEP: SIGMAGPT SCRAMBLE
# ==========================================================================
# Systematic study of conditioning percentage effects on SigmaGPT with
# random scramble ordering (fully random permutation).
#
# Configurations:
...
#
# Usage:
#   ./scripts/submit_sweep_sigmagpt_scramble.sh           # Submit all experiments
#   ./scripts/submit_sweep_sigmagpt_scramble.sh --dry-run # Show what would be submitted
#   ./scripts/submit_sweep_sigmagpt_scramble.sh --skip-baseline # Skip 0-40% (already done)
# ==========================================================================
...
echo "========================================="
echo "CONDITIONING PERCENTAGE SWEEP: SIGMAGPT SCRAMBLE"
echo "========================================="
echo "Configurations: ${#CONFIGS[@]} conditioning ranges"
echo "Model: SigmaGPT (random_scramble ordering)"
...
for config in "${CONFIGS[@]}"; do
    ...
    EXP_NAME="sweep_${LABEL}_sgpt_scram"

    # Construct job name (max 15 chars for SLURM)
    JOB_NAME="${LABEL:0:10}_scram"

    echo "----------------------------------------"
    echo "Experiment: $EXP_NAME"
    echo "  Model: sigmagpt"
    echo "  Ordering: random_scramble"
...
# ==========================================================================
# Experiment: ${EXP_NAME}
# Model: sigmagpt, Ordering: random_scramble
...
echo "  python utils/plot_comparison_metrics.py experiments/sweep_*_sgpt_scram_*"
